            ...
            <div className="hidden lg:flex items-center space-x-3.5">
              {notificationPermission !== "granted" && (
                <button
                  ...
                  className="px-3 py-2 font-mono text-xs font-bold rounded bg-amber-500 hover:bg-amber-600 text-slate-955 flex items-center space-x-1.5 animate-pulse shadow-[0_0_12px_rgba(245,158,11,0.25)]"
                ...
                <>
                  {notificationPermission !== "granted" && (
                    <button
                      ...
                      className="w-full px-3 py-2.5 font-mono text-xs font-bold rounded bg-amber-500 hover:bg-amber-600 text-slate-955 flex items-center justify-center space-x-1.5 animate-pulse shadow-[0_0_12px_rgba(245,158,11,0.25)]"
                    >
                      <span>🔔 Enable System Notifications</span>
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className={`w-full px-3 py-2.5 font-mono text-xs font-semibold rounded border transition-all duration-300 flex items-center justify-center space-x-1.5 ${
                      theme === 'dark' ? 'bg-blue-600/10 text-blue-400 border-blue-500/20 hover:bg-blue-600 hover:text-white' : 'bg-blue-50 text-blue-600 border-blue-200/80 hover:bg-blue-600 hover:text-white'
                    }`}
                  >
                    <HelpCircle className="w-3.5 h-3.5" />
                    <span>Dashboard Tour</span>
                  ...
                  <button
                    ...
                    className={`w-full px-3 py-2.5 font-mono text-xs font-semibold rounded border transition-all duration-300 flex items-center justify-center space-x-1.5 ${
                      theme === 'dark' ? 'bg-slate-900 text-cyan-400 border-cyan-500/20 hover:bg-cyan-600 hover:text-white' : 'bg-white text-cyan-700 border-cyan-200 hover:bg-cyan-600 hover:text-white'
                    }`}
                  >
                    <Settings className="w-3.5 h-3.5" />
                    <span>Configure Fleet & Graph</span>
                  ...
                  <div className="border-t border-slate-200/20 pt-2.5 mt-1 space-y-1.5">
                    <button
                      ...
                      className={`w-full px-4 py-2.5 font-mono text-xs font-semibold rounded border transition-all duration-300 flex items-center justify-center space-x-2 ${
                        simulating
                          ? "bg-slate-900 text-slate-500 border-slate-800 cursor-not-allowed"
                          : (theme === 'dark' ? "bg-red-500/10 text-red-400 border-red-500/30 hover:bg-red-600" : "bg-red-50 text-red-600 border-red-200 hover:bg-red-600 hover:text-white")
                      }`}
                    >
                      <Play className={`w-3.5 h-3.5 ${simulating ? "animate-spin" : ""}`} />
                      <span>{simulating ? "PROCESSING AGENTS..." : "Simulate Failure"}</span>
                        ...
                        <ul>
                          {data?.machines?.map(machine => (
                            <li 
                              ...
                              className={`flex justify-between items-center px-3 py-2 cursor-pointer text-xs border-b last:border-b-0 ${
                                theme === 'dark' ? 'border-[#2b3548]/50 hover:bg-[#202a3d] text-slate-300' : 'border-slate-100 hover:bg-slate-50'
                              }`}
                            >
                              <span className="truncate max-w-[130px] font-medium">{machine.name}</span>
