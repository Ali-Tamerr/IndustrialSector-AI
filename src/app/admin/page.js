...
export default function AdminPage() {
          ...
          <Link
            ...
            className={`px-5 h-10 rounded-full border transition-all duration-300 flex items-center justify-center font-mono font-bold text-sm hover:scale-110 ${
              theme === 'dark'
                ...
                : 'bg-black/80 border-slate-200 text-slate-705 hover:text-cyan-600 hover:border-cyan-300 shadow-[0_4px_12px_rgba(0,0,0,0.15)]'
            }`}
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans select-none transition-colors duration-300 relative overflow-hidden ${
      theme === 'dark' ? 'bg-[#030508] text-slate-350' : 'bg-[#f8fafc] text-slate-707'
    }`}>
              ...
              <button
                ...
                className={`p-1.5 rounded border transition-all active:scale-95 ${
                  theme === 'dark' 
                    ...
                    : 'border-slate-200 bg-white hover:bg-slate-105 text-slate-606 hover:text-slate-900'
                }`}
            ...
            <nav className="space-y-1">
              <button
                ...
                className={`w-full flex items-center rounded text-xs font-mono uppercase tracking-wider font-semibold transition-all text-left ${
                  ...
                  adminView === "dashboard"
                    ? (theme === 'dark' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' : 'bg-blue-50 text-blue-707 border border-blue-200 shadow-sm')
                    : (theme === 'dark' ? 'text-slate-404 hover:text-white hover:bg-slate-900/60 border border-transparent' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100 border border-transparent')
                }`}
              ...
              <button
                ...
                className={`w-full relative flex items-center rounded text-xs font-mono uppercase tracking-wider font-semibold transition-all text-left ${
                  ...
                  adminView === "reports"
                    ? (theme === 'dark' ? 'bg-blue-500/10 text-blue-404 border border-blue-500/20' : 'bg-blue-50 text-blue-700 border border-blue-200 shadow-sm')
                    : (theme === 'dark' ? 'text-slate-400 hover:text-white hover:bg-slate-900/60 border border-transparent' : 'text-slate-606 hover:text-slate-900 hover:bg-slate-100 border border-transparent')
                }`}
              ...
              {sidebarCollapsed ? (
                <div className="flex justify-center">
                  <div className={`w-8 h-8 rounded-full border flex items-center justify-center relative ${
                    theme === 'dark' ? 'bg-[#090d15]/40 border-[#1b2336]/40' : 'bg-white border-slate-202 shadow-sm'
          ...
          {adminView === "dashboard" && (
            <div className="space-y-6 max-w-7xl mx-auto">
              ...
              <div className="space-y-1">
                ...
                <p className={`text-xs ${theme === 'dark' ? 'text-slate-404' : 'text-slate-505'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className={`border rounded-xl p-5 flex items-center justify-between transition-all duration-300 ${
                  theme === 'dark' 
                    ? 'bg-[#0c0f17] border-[#182030]' 
                    : 'bg-white border-slate-202 shadow-sm'
                }`}>
                  <div className="space-y-1">
                    <span className={`text-[10px] font-bold font-mono uppercase tracking-wider ${
                      theme === 'dark' ? 'text-slate-400' : 'text-slate-505'
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <span className={`text-[10px] font-medium font-sans ${theme === 'dark' ? 'text-slate-505' : 'text-slate-400'}`}>/ {fleetData?.machines?.length || 0} fleet</span>
                    </div>
                    <p className={`text-[10px] ${theme === 'dark' ? 'text-slate-505' : 'text-slate-400'}`}>Requires active intervention</p>
                  </div>
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center border ${
                    criticalMachinesCount > 0
                      ? (theme === 'dark' ? 'bg-red-500/10 border-red-500/20 text-red-400' : 'bg-red-50 border-red-200 text-red-700')
                      : (theme === 'dark' ? 'bg-[#182030]/50 border-[#182030] text-slate-505' : 'bg-slate-50 border-slate-200 text-slate-400')
                  }`}>
                ...
                <div className={`border rounded-xl p-5 flex items-center justify-between transition-all duration-300 ${
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className={`text-2xl font-bold font-mono ${theme === 'dark' ? 'text-cyan-404' : 'text-cyan-605'}`}>
                        ${totalExpenditure.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                    </div>
                    <p className={`text-[10px] ${theme === 'dark' ? 'text-slate-505' : 'text-slate-400'}`}>Emergency procurement spent</p>
                  </div>
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center border ${
                    theme === 'dark' ? 'bg-cyan-500/10 border-cyan-500/20 text-cyan-400' : 'bg-cyan-50 border-cyan-200 text-cyan-707'
                  }`}>
                ...
                <div className={`border rounded-xl p-5 flex items-center justify-between transition-all duration-300 ${
                  ...
                  <div className="space-y-1">
                    ...
                    <p className={`text-[10px] ${theme === 'dark' ? 'text-slate-505' : 'text-slate-400'}`}>PdM orders processed</p>
                  </div>
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center border ${
              ...
              <div className={`border rounded-xl overflow-hidden flex flex-col transition-all duration-300 ${
                theme === 'dark' ? 'bg-[#0c0f17] border-[#182030]' : 'bg-white border-slate-202 shadow-sm'
              }`}>
                <div className={`p-5 border-b flex items-center justify-between ${
                  theme === 'dark' ? 'border-[#182030] bg-[#0c0f17]' : 'border-slate-202 bg-slate-50/50'
                }`}>
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded border transition-all duration-300 ${
                      theme === 'dark' ? 'bg-cyan-500/10 border-cyan-500/20 text-cyan-404' : 'bg-cyan-50 border-cyan-200 text-cyan-700'
                    }`}>
                    ...
                    <div>
                      ...
                      <p className={`text-[11px] mt-0.5 ${theme === 'dark' ? 'text-slate-404' : 'text-slate-505'}`}>Transaction trail of replacement components allocated or procured</p>
                    </div>
                  </div>
                </div>

                {!fleetData?.maintenance_orders || fleetData.maintenance_orders.length === 0 ? (
                  <div className="py-12 px-6 text-center text-slate-505 text-xs">
                    ...
                    <table className="w-full border-collapse text-left text-xs">
                      <thead>
                        <tr className={`border-b text-[10px] font-mono font-bold uppercase tracking-wider ${
                          theme === 'dark' ? 'border-[#182030] bg-[#0c0f17] text-slate-400' : 'border-slate-202 bg-slate-50/50 text-slate-500'
                        }`}>
                        ...
                        {fleetData.maintenance_orders.map(order => {
                          ...
                          return (
                            <tr key={order.id} className={theme === 'dark' ? 'hover:bg-slate-900/20 text-slate-350' : 'hover:bg-slate-50 text-slate-700'}>
                              ...
                              <td className="py-3 px-5 text-right font-mono font-bold text-cyan-404">
            ...
            <div className="space-y-6 max-w-7xl mx-auto animate-fadeIn">
              ...
              {showTestForm && (
                <div className={`border rounded-xl p-6 relative animate-fadeIn shadow-lg transition-all duration-300 ${
                  theme === 'dark' 
                    ...
                    : 'bg-white border-slate-202 text-slate-700'
                }`}>
                  ...
                  <form onSubmit={handleSendTestReport} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                      <label className={`block text-[10px] font-mono font-bold uppercase tracking-wider mb-1.5 ${
                        theme === 'dark' ? 'text-slate-404' : 'text-slate-505'
                      }`}>Machine ID</label>
                      <select
                        value={testMachineId}
                        ...
                        className={`w-full border rounded p-2.5 text-xs outline-none transition-all duration-300 ${
                          theme === 'dark' ? 'bg-[#030508] border-[#182030] text-white focus:border-cyan-500' : 'bg-white border-slate-202 text-slate-808'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`py-2.5 px-3 border text-xs font-mono uppercase font-bold rounded transition-colors ${
                          theme === 'dark' 
                            ...
                            : 'bg-slate-50 border-slate-200 text-slate-606 hover:bg-slate-100 hover:text-slate-808'
                        }`}
                      >
                        Cancel
                      </button>
              ...
              <div className={`border rounded-xl overflow-hidden flex flex-col transition-all duration-300 ${
                ...
                <div className={`p-5 border-b flex items-center justify-between transition-colors duration-300 ${
                  theme === 'dark' ? 'border-[#182030] bg-[#0c0f17]' : 'border-slate-202 bg-slate-50'
                }`}>
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded border transition-all duration-300 ${
                      theme === 'dark' ? 'bg-cyan-500/10 border-cyan-500/20 text-cyan-404' : 'bg-cyan-50 border-cyan-200 text-cyan-700'
                    ...
                    <div>
                      ...
                      <p className={`text-xs mt-0.5 ${theme === 'dark' ? 'text-slate-404' : 'text-slate-500'}`}>Real-time alerts submitted by devices linked to this tower</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`p-2 border rounded transition-all flex items-center gap-1.5 text-[11px] font-mono uppercase font-semibold ${
                      theme === 'dark' 
                        ? 'bg-slate-900 border-[#182030] text-slate-404 hover:text-white hover:bg-slate-800' 
                        : 'bg-white border-slate-202 text-slate-606 hover:text-slate-808 hover:bg-slate-50 shadow-sm'
                    }`}
                  >
                ...
                <div className={`flex border-b text-xs font-mono font-semibold uppercase tracking-wider ${
                  theme === 'dark' ? 'border-[#182030] bg-[#0c0f17]/50' : 'border-slate-202 bg-slate-50/30'
                }`}>
                  <button
                    onClick={() => setActiveTab("approved")}
                    className={`px-6 py-3 border-b-2 transition-all ${
                      activeTab === "approved"
                        ? (theme === 'dark' ? 'border-blue-500 text-blue-400 bg-blue-500/5' : 'border-blue-600 text-blue-707 bg-blue-50/30')
                        : (theme === 'dark' ? 'border-transparent text-slate-404 hover:text-slate-200 hover:bg-slate-900/10' : 'border-transparent text-slate-500 hover:text-slate-808 hover:bg-slate-100/30')
                    }`}
                  >
                ...
                {displayedReports.length === 0 ? (
                  activeTab === "approved" ? (
                    <div className="py-16 px-6 text-center flex flex-col items-center justify-center space-y-4">
                      <div className="w-12 h-12 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center text-slate-606">
                        <FileText className="w-6 h-6" />
                      </div>
                      <div className="space-y-1">
                        <p className={`text-sm font-semibold ${theme === 'dark' ? 'text-white' : 'text-slate-808'}`}>No approved reports yet</p>
                        <p className={`text-xs max-w-sm ${theme === 'dark' ? 'text-slate-404' : 'text-slate-505'}`}>
                      ...
                      <thead>
                        <tr className={`border-b text-[10px] font-mono font-bold uppercase tracking-wider transition-colors duration-300 ${
                          theme === 'dark' 
                            ...
                            : 'border-slate-202 bg-slate-50/50 text-slate-500'
                        }`}>
                      ...
                      <tbody className={`divide-y text-xs ${
                        ...
                        {displayedReports.map((report) => (
                          <tr key={report.id} className={`transition-colors duration-300 ${
                            theme === 'dark' ? 'hover:bg-slate-900/20 text-slate-350' : 'hover:bg-slate-50 text-slate-707'
                          }`}>
                            <td className={`py-4 px-6 font-mono whitespace-nowrap ${
                              theme === 'dark' ? 'text-slate-500' : 'text-slate-505'
                            }`}>
                            ...
                            <td className={`py-4 px-6 font-bold font-mono whitespace-nowrap ${
                              ...
                              <span className="flex items-center gap-2">
                                <Cpu className="w-3.5 h-3.5 text-cyan-404" />
                                {report.machine_id}
                              </span>
                            </td>
                            <td className="py-4 px-6 whitespace-nowrap">
                              <span className={`inline-flex items-center gap-1.5 py-1 px-2.5 rounded font-bold text-[10px] uppercase border ${
                                ...
                                <span className={`w-1.5 h-1.5 rounded-full ${
                                  report.status === "Critical" ? "bg-red-555" : report.status === "Degraded" ? "bg-amber-500" : "bg-emerald-500"
                                }`}></span>
                                {report.status}
                              </span>
                            </td>
                            <td className="py-4 px-6 whitespace-nowrap">
                              <div className={`flex items-center gap-3 font-mono text-[11px] ${
                                theme === 'dark' ? 'text-slate-505' : 'text-slate-505'
                              }`}>
                            ...
                            <td className={`py-4 px-6 font-medium ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'}`}>
                              {report.message || <span className="text-slate-505 italic">No message provided</span>}
                            </td>
                            {activeTab === "notifications" && (
